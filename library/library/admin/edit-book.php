...
header('location:index.php');
    ...
    if(isset($_POST['update']))
    {
        ...
        // Removed the $price variable and its assignment
    
        $sql="update  tblbooks set BookName=:bookname,CatId=:category,AuthorId=:author,ISBNNumber=:isbn where id=:bookid"; // Removed BookPrice=:price
